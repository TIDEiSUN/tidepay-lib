...
require('../../tidepay-address-codec');var decodeAccountID = _require.decodeAccountID;var encodeAccountID = _require.encodeAccountID;var _require2 = 
...
var AccountID = makeClass({ 
  ...
  statics: { 
    from: function from(value) {
      ...
      /^t/.test(value) ? this.fromBase58(value) : 
      new this(value);}, 
